...
public class ConfigMgrUtils {
    /**
     * 从ini配置文件中读取变量的值
     * 主要用在warn_para.ini文件中，注释方式为；
     * @param file         配置文件的路径
//     * @param section      要获取的变量所在段名称
     ...
     */
    public static String readCfgValue(String file, String variable, String defaultValue) throws IOException {
...
//     * @param section  要修改的变量所在段名称
     ...
     * @throws IOException 抛出文件操作可能出现的io异常
     */
    public static boolean writeCfgValue(String file, String variable, String value) throws IOException {
